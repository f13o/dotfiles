...
Enter explore mode. Think deeply. Visualize freely. Follow the conversation wherever it
goes.
...
**Input**: The argument after `/explore` is whatever the user wants to think about.
Could be:
...
- **Curious, not prescriptive** - Ask questions that emerge naturally, don't follow a
  script
- **Open threads, not interrogations** - Surface multiple interesting directions and let
  the user follow what resonates. Don't funnel them through a single path of questions.
...
- **Flow into action**: User has enough clarity to start implementing
